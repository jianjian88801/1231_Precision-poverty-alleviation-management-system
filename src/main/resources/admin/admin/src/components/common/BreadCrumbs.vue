<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(255, 252, 252, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:2px;borderStyle:dotted solid double dashed;borderColor:rgba(254, 251, 251, 0.96);">
